    ...
    <div className={`${isCollapsed ? 'w-[80px]' : 'w-[295px]'} ${isDarkMode ? 'bg-[#03112F]' : 'bg-white'} flex flex-col h-screen shadow-[0_20px_40px_0_rgba(0,47,189,0.10)] transition-all duration-300`}>
      ...
      <div className="flex flex-col px-4 pt-6 pb-4 gap-6 flex-shrink-0">
        ...
        <div className="flex h-10 items-center justify-between">
          {/* Back Arrow Icon - Always visible */}
          <button onClick={onBack} className="flex-shrink-0 p-1 hover:opacity-70">
          ...
          {/* Menu Icon - Clickable */}
          <button onClick={() => setIsCollapsed(!isCollapsed)} className="flex-shrink-0 p-1 hover:opacity-70">
        ...
        <div className="flex items-start justify-between">
          ...
          <button 
            ...
            onClick={onBack}
          >
            <ArrowLeft className="w-6 h-6" style={{ color: '#2861BB' }} />
            <span style={{ color: '#2861BB', fontSize: '14px', fontWeight: 500, lineHeight: '150%' }}>
              Back
            </span>
          </button>
