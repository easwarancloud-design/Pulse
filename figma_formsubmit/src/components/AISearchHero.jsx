          ...
          >
            <div className="flex items-center gap-2 flex-1 min-w-0">
              ...
              <input
                ...
                className="bg-transparent border-none outline-none text-white placeholder-white flex-1 min-w-0"
                style={{
                  fontFamily: 'Elevance Sans, -apple-system, Roboto, Helvetica, sans-serif',
                  fontSize: '20px',
                  fontWeight: '400',
            ...
            <div className="flex justify-between items-center gap-4 flex-1 ml-4">
              {getCurrentQuestions().map((question, index) => (
                <button
                  ...
                  className="flex items-center px-4 py-3 cursor-pointer hover:opacity-80 transition-opacity"
                  style={{
                    borderRadius: '100px',
                    border: '1px solid #44B8F3',
                    background: 'rgba(5, 15, 38, 0.40)'
