...
const ExpandedSidebar = ({ agents, threads, onBack, onAddNewChat, onSelectChat, chats }) => {
  ...
  return (
    <div className="flex flex-col h-full overflow-y-auto overflow-x-hidden px-4 pb-4">
      {/* Search Input */}
      ...
      <div className="flex-grow overflow-y-visible overflow-x-hidden pr-2">
...
const Sidebar = ({ isExpanded, toggleExpand, onBack, groupedChats, addNewChat, chats, onSelectChat }) => {
  ...
  return (
    <div
      ...
      style={{
        width: isExpanded ? '23%' : '64px',
        minWidth: isExpanded ? '200px' : '64px', // Minimum width to ensure readability
        maxWidth: isExpanded ? '300px' : '64px', // Increased max width slightly to 300px
