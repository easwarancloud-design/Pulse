      ...
      <div className="relative w-full" style={{ zIndex: 10 }}>
        ...
        <div className="flex flex-col items-start gap-2.5 w-full max-w-[1184px] mx-auto relative">
          ...
          >
            ...
            >
              {/* Static suggestions (pre-rendered). Original dynamic map removed for now. */}
              <li role="option" data-suggestion-id="thread-101" className="suggestion-li">
                <button
                  type="button"
                ...
                >
                  ...
                  >
                    Quarterly Planning Thread
                  </span>
                </button>
              </li>
              <li role="option" data-suggestion-id="thread-102" className="suggestion-li">
                <button
                  type="button"
                  className="suggestion-item-btn flex items-center hover:bg-white/10 cursor-pointer transition-all duration-200 w-full text-left"
                  style={{
              ...
              <li role="option" data-suggestion-id="thread-103" className="suggestion-li">
                <button
                  type="button"
                  className="suggestion-item-btn flex items-center hover:bg-white/10 cursor-pointer transition-all duration-200 w-full text-left"
                  style={{
                ...
                >
                  ...
                  >
                    Open Meeting Room Requests
                  </span>
                </button>
              </li>
              <li role="option" data-suggestion-id="thread-104" className="suggestion-li">
                <button
                  type="button"
                  className="suggestion-item-btn flex items-center hover:bg-white/10 cursor-pointer transition-all duration-200 w-full text-left"
                  style={{
              ...
              <li role="option" data-suggestion-id="thread-105" className="suggestion-li">
                <button
                  type="button"
                  className="suggestion-item-btn flex items-center hover:bg-white/10 cursor-pointer transition-all duration-200 w-full text-left"
                  style={{
