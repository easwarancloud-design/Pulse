    ...
    >
      ...
      <div className="relative w-full" style={{ zIndex: 10 }}>
        ...
        <div className="flex flex-col items-start gap-2.5 w-full max-w-[1184px] mx-auto relative">
          ...
          >
            <ul id="pulse-suggestions" style={{ display: 'none' }} aria-hidden="true">
              <li data-suggestion-id="thread-101">Quarterly Planning Thread</li>
              <li data-suggestion-id="thread-102">Performance Review Summary</li>
              <li data-suggestion-id="thread-103">Open Meeting Room Requests</li>
              <li data-suggestion-id="thread-104">Latest HR Announcements</li>
              <li data-suggestion-id="thread-105">Policy Change Digest</li>
            </ul>
          </div>
        </div>
