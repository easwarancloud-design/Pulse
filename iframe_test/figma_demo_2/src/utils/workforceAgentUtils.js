...
export const cleanStreamText = (msg) => {
  ...
  // Only log occasionally to reduce spam (every 10th call or for final text)
  const shouldLog = Math.random() < 0.1 || msg.length > 1000;
  
  if (shouldLog) {
    console.log('🧹 cleanStreamText processing...');
  }
