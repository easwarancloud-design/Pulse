...
import {
  Menu, ChevronDown, Search, Bell, Mic, LayoutGrid, Globe, Users, MapPin, Briefcase, ChevronRight, Check, RotateCw, Send
} from 'lucide-react';
...
const App = ({ onSearch, user, authService }) => {
  const handleSearch = (question, conversationId = null, type = null) => {
    // Pass question, conversationId, and type to parent
    onSearch(question, conversationId, type);
  };

  return (
    // Use the Inter font, which is the default for modern Tailwind
    <div className="font-sans min-h-screen bg-gray-50">
      <PrimaryNavbar user={user} authService={authService} />
