...
from modules.workflow_utils import replace_short_names,get_workday_message_et
...
def get_payrollhr(state: AgentState):
    ...
    prompt=f''' You are a friendly, helpful conversational agent for inquiries related to given JSON object.
                ...
                For queries related to hybrid work, time and absence, or compensation, include the latest data timestamp at the end of the response, 
    ...
    logger.info(f'payroll prompt:{prompt}')
